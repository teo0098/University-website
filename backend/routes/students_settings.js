...
router.get('/students/settings', function (req, res) {
...
router.post('/students/alteration', function (req, res) {
    if (req.session.logged) {
        ...
        dbconnection_1.default.query(select, ["" + req.session.logged[6].value], function (err, result) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        e_1 = _a.sent();
                        if (typeof e_1 === null || typeof e_1 === "undefined") {
                            e_1 = 'We weren\'t able to encrypt your password. Please try again later.';
                        }
                        res.status(404).redirect("/students/settings?error=" + encodeURIComponent(e_1));
                        return [3 /*break*/, 7];
...
router.post('/students/removal', function (req, res) {
    if (req.session.logged) {
